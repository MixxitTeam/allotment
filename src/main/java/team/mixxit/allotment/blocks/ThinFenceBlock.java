...
public class ThinFenceBlock extends FourWayBlock {
    private final VoxelShape[] renderShapes;

    public ThinFenceBlock(AbstractBlock.Properties properties) {
        super(1.0F, 1.0F, 16.0F, 15.0F, 24.0F, properties);
        ...
        this.renderShapes = this.makeShapes(1.0F, 1.0F, 16.0F, 6.0F, 15.0F);
    }
