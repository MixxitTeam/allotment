...
# Instead, edit _data/weathered_acacia_planks.mmd
layout: block
category: block
...
sourcefile:
  exists: false
  fullpath: _data/weathered_acacia_planks.mmd
  path: _data
  name: weathered_acacia_planks.mmd
todo: false
---

<table class="block-info"><thead><tr>
<th colspan=2>Weathered Acacia Planks</th>
</tr></thead><tbody>
<tr><td colspan=2 class="cell-image-big" style="text-align:center"><img onerror="this.src={{ "/img/missing_lg.png" | relative_url | jsonify | escape }}" src="/allotment/img/textures/allotment/weathered_acacia_planks.png" width="256" height="256" alt="" class="preview-icon"></td></tr>
<tr><td colspan=2 class="cell-image-small" style="text-align:center"><img onerror="this.src={{ "/img/missing.png" | relative_url | jsonify | escape }}" src="/allotment/img/inventory_textures/allotment/weathered_acacia_planks.png" width="32" height="32" alt="" class="inventory-icon"></td></tr>
...
<span title="Chipped Acacia Planks" class="item item-allotment:chipped_acacia_planks item-type-item" style="background-image:url(&quot;/allotment/img/inventory_textures/allotment/chipped_acacia_planks.png&quot;)"></span>
</div>
<div class="crafting-ingredient">
...
<span title="Weathered Acacia Planks" class="item item-allotment:weathered_acacia_planks" style="background-image:url(&quot;/allotment/img/inventory_textures/allotment/weathered_acacia_planks.png&quot;)"></span>
</div>
</div>
</td>
</tr></tbody></table>