...
# Instead, edit _data/chipped_jungle_planks.mmd
layout: block
category: block
...
sourcefile:
  exists: false
  fullpath: _data/chipped_jungle_planks.mmd
  path: _data
  name: chipped_jungle_planks.mmd
todo: false
---

<table class="block-info"><thead><tr>
<th colspan=2>Chipped Jungle Planks</th>
</tr></thead><tbody>
<tr><td colspan=2 class="cell-image-big" style="text-align:center"><img onerror="this.src={{ "/img/missing_lg.png" | relative_url | jsonify | escape }}" src="/allotment/img/textures/allotment/chipped_jungle_planks.png" width="256" height="256" alt="" class="preview-icon"></td></tr>
<tr><td colspan=2 class="cell-image-small" style="text-align:center"><img onerror="this.src={{ "/img/missing.png" | relative_url | jsonify | escape }}" src="/allotment/img/inventory_textures/allotment/chipped_jungle_planks.png" width="32" height="32" alt="" class="inventory-icon"></td></tr>
...
<span title="Jungle Planks" class="item item-minecraft:jungle_planks item-type-item" style="background-image:url(&quot;/allotment/img/inventory_textures/minecraft/jungle_planks.png&quot;)"></span>
</div>
<div class="crafting-ingredient">
...
<span title="Chipped Jungle Planks" class="item item-allotment:chipped_jungle_planks" style="background-image:url(&quot;/allotment/img/inventory_textures/allotment/chipped_jungle_planks.png&quot;)"></span>
</div>
</div>
</td>
</tr></tbody></table>