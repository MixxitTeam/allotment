...
# Instead, edit _data/bamboo_fence_gate.mmd
layout: block
category: block
...
sourcefile:
  exists: false
  fullpath: _data/bamboo_fence_gate.mmd
  path: _data
  name: bamboo_fence_gate.mmd
todo: false
---
...
<tr><td colspan=2 class="cell-image-big" style="text-align:center"><img onerror="this.src={{ "/img/missing_lg.png" | relative_url | jsonify | escape }}" src="/allotment/img/textures/allotment/bamboo_fence_gate.png" width="256" height="256" alt="" class="preview-icon"></td></tr>
<tr><td colspan=2 class="cell-image-small" style="text-align:center"><img onerror="this.src={{ "/img/missing.png" | relative_url | jsonify | escape }}" src="/allotment/img/inventory_textures/allotment/bamboo_fence_gate.png" width="32" height="32" alt="" class="inventory-icon"></td></tr>
